...
BEGIN_C_DECLS
  ...
  *
  * @retval CCI_SUCCESS On success
  * @retval CCI_ERROR On failure
  *
...
__cci_attribute_nonnull__(3);
  ...
  * @retval CCI_ERROR On failure
  *
  * This function is identical to the cci_argv_append() function
  ...
  */
CCI_DECLSPEC int cci_argv_append_nosize(char ***argv, const char *arg);
 ...
 * @retval CCI_ERROR On failure
 *
 * This function is identical to the cci_argv_append_nosize() function
...
/**
   ...
   * array.
   */
CCI_DECLSPEC void cci_argv_free(char **argv);
...
CCI_DECLSPEC int cci_argv_delete(int *argc, char ***argv,
  ...
  *
  * @retval CCI_SUCCESS upon success
  * @retval CCI_BAD_PARAM if any parameters are non-sensical
  *
  ...
  * Similar to cci_argv_append(), the target may be realloc()'ed
